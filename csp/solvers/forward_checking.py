...
class LatinSquareForward(GraphForwardSolver):
    def __init__(self, *args):
        super(LatinSquareForward, self).__init__(*args)
    ...
    def remove_adjacency_conflits(self, n, value, forward_matrix):
        adj_row = np.copy(self.adjacency_matrix[n]) * self.FORWARD_BANNED_VALUE
        forward_matrix[value] += adj_row
